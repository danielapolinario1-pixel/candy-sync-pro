...
import { Download, Share2, MessageCircle, Printer, Bluetooth, Eye } from "lucide-react";
...
import { imprimirTermicaHtml, imprimirBluetooth, bluetoothDisponivel } from "@/lib/termica";
...
export const Route = createFileRoute("/_authenticated/pedidos/$id")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Detalhe do pedido de venda com PDF A4, impressão térmica 80mm e WhatsApp." },
      { property: "og:title", content: "Detalhe do pedido | SSD ATACADO" },
      { property: "og:description", content: "PDF A4, impressão térmica, compartilhamento e envio por WhatsApp." },
    ],
  }),
    ...
    },
    {
      ...
      acao: async () => {
        ...
        try {
          ...
          toast.error(e instanceof Error ? e.message : "Falha na impressão Bluetooth");
        }
      },
    },
    {
